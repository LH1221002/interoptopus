...
pub struct GameEngine {
    engine: rust_library::engine::GameEngine,
}
...
impl GameEngine {
    ...
    pub fn new() -> Result<Self, Error> {
        let engine = rust_library::engine::GameEngine::new();
        Ok(Self { engine })
    }
...
impl Vec2 {
    ...
    fn into_native(self) -> rust_library::engine::Vec2 {
        rust_library::engine::Vec2 { x: self.x, y: self.y }
    }
}
